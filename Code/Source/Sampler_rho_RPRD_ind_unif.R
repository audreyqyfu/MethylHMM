#######################################################
# Sampler_rho_RPRD_ind_unif
#
# 2011.10.10: Modified to estimate rho_RP=rho_RD.
# 2010.09.12: Pass argument dist to loglikHMM.
# 2010.09.10: Discrete model representation.
# 
# Function to update rho_RP=rho_RD using a 
# uniform prior.  
# 
...
Sampler_rho_RPRD_ind_unif = function (rho.curr, n.proc, data, dist, tau, m, m.denovo, m.maint, d.denovo, d.maint, b, c, sd.rho, lower, upper, DE.NOVO=1, PRINT.FLAG=0)
{
	...
	par.new = rnorm (1, rho.curr[2], sd.rho)
	lambda.new[n.proc+2:3] = ifelse ((par.new<lower) | (par.new>upper), reflect (par.new, lower, upper), par.new)
